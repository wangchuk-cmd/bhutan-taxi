    ...
    <nav class="navbar navbar-expand-lg navbar-dark sticky-top">
        <div class="container-fluid px-3">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <a class="btn btn-sm btn-outline-light position-relative" href="{{ route('notifications.index') }}" title="Notifications">
                    <i class="bi bi-bell"></i>
                    <span id="adminUnreadBadge" class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger d-none">0</span>
                </a>
                <div class="dropdown">
    ...
    <div class="d-flex">
        ...
        <div class="sidebar sidebar-dark d-none d-lg-block" style="position: fixed; width: 220px; top: 56px; height: calc(100vh - 56px); overflow-y: auto;">
            <nav class="nav flex-column py-3">
                ...
                <a class="nav-link {{ request()->routeIs('admin.reports*') && request('tab') !== 'refunds' ? 'active' : '' }}" href="{{ route('admin.reports') }}">
                    <i class="bi bi-graph-up me-2"></i>Reports
                </a>
                <a class="nav-link {{ request()->routeIs('admin.refunds*') ? 'active' : '' }}" href="{{ route('admin.refunds') }}">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-0">
                    <div class="list-group list-group-flush">
                        ...
                        <a class="list-group-item list-group-item-action py-3" href="{{ route('admin.refunds') }}">
                            <i class="bi bi-arrow-counterclockwise me-3 text-success"></i>Refunds
                        </a>
